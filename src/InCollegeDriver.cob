...
DATA DIVISION.
    ...
    WORKING-STORAGE SECTION.
        ...
        01 CONN-LNK-PARAMETERS.
            05 CONN-LNK-OPERATION    PIC X(2).
            05 CONN-LNK-RETURN-CODE    PIC X.
            05 CONN-LNK-RETURN-MSG    PIC X(100).
            05 CONN-LNK-PEND-RECORD.
...
PROCEDURE DIVISION.
    ...
    SEND-CONNECTION-REQUEST.
        ...
        ELSE
            MOVE SPACES TO WS-PEND-SENDER-FIRST
            MOVE SPACES TO WS-PEND-SENDER-LAST
        END-IF

        MOVE "C1" TO CONN-LNK-OPERATION
        MOVE WS-PEND-RECORD TO CONN-LNK-PEND-RECORD
        CALL 'CONNECTIONLOGIC' USING CONN-LNK-OPERATION, CONN-LNK-RETURN-CODE, CONN-LNK-RETURN-MSG, CONN-LNK-PEND-RECORD
        MOVE CONN-LNK-RETURN-MSG TO WS-OUT-LINE
        PERFORM DISPLAY-LINE
